          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="device_type" value="<?php echo $this->input->post('device_type'); ?>" class="form-control" id="device_type" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="device_sn" class="control-label">Device Sn</label>
						<div class="form-group">
							<input type="text" name="device_sn" value="<?php echo $this->input->post('device_sn'); ?>" class="form-control" id="device_sn" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="device_other" class="control-label">Device Other</label>
						<div class="form-group">
							<input type="text" name="device_other" value="<?php echo $this->input->post('device_other'); ?>" class="form-control" id="device_other" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="device_description" class="control-label">Device Description</label>
						<div class="form-group">
							<textarea name="device_description" class="form-control" id="device_description"><?php echo $this->input->post('device_description'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
