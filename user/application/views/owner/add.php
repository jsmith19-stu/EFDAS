    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Owner Add</h3>
            </div>
            <?php echo form_open('owner/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="street" value="<?php echo $this->input->post('street'); ?>" class="form-control" id="street" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="parish" value="<?php echo $this->input->post('parish'); ?>" class="form-control" id="parish" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="phone_1" class="control-label">Phone 1</label>
						<div class="form-group">
							<input type="text" name="phone_1" value="<?php echo $this->input->post('phone_1'); ?>" class="form-control" id="phone_1" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="phone_2" class="control-label">Phone 2</label>
						<div class="form-group">
							<input type="text" name="phone_2" value="<?php echo $this->input->post('phone_2'); ?>" class="form-control" id="phone_2" />
						</div>
					</div>
					<div class="col-md-6">
